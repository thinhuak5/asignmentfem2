                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-6 col-lg-5 col-xl-4">
                            <div className="card p-4 shadow-lg border-0 rounded-3">
                                <div className="alert alert-danger">Link đặt lại mật khẩu không hợp lệ hoặc đã hết hạn.</div>
                                <p className="text-center mt-3">
                                    <Link to="/admin/forgot-password" className="btn btn-primary">Yêu cầu link mới</Link>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-6 col-lg-5 col-xl-4">
                        <div className="card p-4 shadow-lg border-0 rounded-3">
                            ...
                            <p className="mt-4 text-center">
                                <Link to="/admin-login" className="text-decoration-none">Quay lại đăng nhập quản trị</Link>
                            </p>
                        </div>
                    </div>
                </div>
