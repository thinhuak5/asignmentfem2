...
const Profile = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const fullAddress = `${editedProfile.detailAddress}, ${
        wards.find((w) => w.code == editedProfile.wardCode)?.name || ""
      }, ${
        districts.find((d) => d.code == editedProfile.districtCode)?.name || ""
      }, ${
        provinces.find((p) => p.code == editedProfile.provinceCode)?.name || ""
      }`;
      ...
      fetchProfile(); // Load lại dữ liệu sau khi cập nhật
      setIsEditing(false);
        ...
        {isEditing ? (
          <>
            ...
            <select
              ...
              value={editedProfile.provinceCode || ""}
              onChange={(e) => {
            ...
            <select
              style={{ ...styles.input, marginBottom: "10px" }}
              value={editedProfile.districtCode || ""}
              onChange={(e) => {
              ...
              disabled={!editedProfile.provinceCode}
            >
            ...
            <select
              ...
              disabled={!editedProfile.districtCode}
            >
            ...
            <input
              ...
              value={editedProfile.detailAddress || ""}
              onChange={(e) =>
                setEditedProfile({
                  ...editedProfile,
      ...
      <div style={styles.sidebar}>
        <div style={styles.sidebarHeader}>
          ...
          <div>
            ...
            <div style={styles.sidebarUserRank}>
        ...
        <ul style={styles.sidebarNav}>
          ...
          >
            <Icon name="user" style={styles.sidebarNavIcon} /> Thông tin tài
            khoản
          </li>
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "myOrders" && styles.sidebarNavItemActive),
            }}
            onClick={() => setActiveNavItem("myOrders")}
          >
            <Icon name="order" style={styles.sidebarNavIcon} />{" "}
          ...
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "gtgt" && styles.sidebarNavItemActive),
            }}
            onClick={() => setActiveNavItem("gtgt")}
          >
            <Icon name="gtgt" style={styles.sidebarNavIcon} /> Thông tin xuất
            hóa đơn GTGT
          </li>
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "memberPrivileges" &&
                styles.sidebarNavItemActive),
            }}
          ...
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "vouchers" && styles.sidebarNavItemActive),
            }}
            onClick={() => setActiveNavItem("vouchers")}
          >
            <Icon name="voucher" style={styles.sidebarNavIcon} /> Ví voucher{" "}
            <span
              style={{
                backgroundColor: colors.primaryRed,
                color: colors.white,
          ...
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "fPointFreeship" &&
                styles.sidebarNavItemActive),
            }}
            onClick={() => setActiveNavItem("fPointFreeship")}
          >
            <Icon name="f-point" style={styles.sidebarNavIcon} /> Tài khoản
            F-Point / Freeship
          </li>
          <li
            style={{
          ...
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "wishlist" && styles.sidebarNavItemActive),
            }}
            onClick={() => setActiveNavItem("wishlist")}
          >
            <Icon name="heart" style={styles.sidebarNavIcon} /> Sản phẩm yêu
            thích
          </li>
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "myBooks" && styles.sidebarNavItemActive),
            }}
          ...
          <li
            style={{
              ...styles.sidebarNavItem,
              ...(activeNavItem === "myReviews" && styles.sidebarNavItemActive),
            }}
            onClick={() => setActiveNavItem("myReviews")}
          >
            <Icon name="comment" style={styles.sidebarNavIcon} /> Nhận xét của
            tôi
          </li>
        </ul>
      </div>
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.alertBanner}>
          ...
          <span>
            ...
            <span style={styles.linkText}>Cập nhật thông tin ngay</span>
          </span>
        </div>
